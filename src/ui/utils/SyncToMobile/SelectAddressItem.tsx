...
export const SelectAddressItem: React.FC<{
  ...
  const { whitelistEnable, whiteList } = useVibe3Selector((s) => ({
    ...
    >
      <div
        className={clsx(
          ...
          'hover:bg-r-blue-light1 hover:border-vibe3-blue-default',
          checked && 'bg-r-blue-light1 border-vibe3-blue-default',
        ...
        <div className={clsx('flex items-center gap-[12px]', 'flex-1')}>
          ...
          <div className={clsx('flex-1', 'flex flex-col gap-[4px]')}>
            ...
            <div className={clsx('flex items-center gap-[4px]')}>
              <div
                className={clsx(
                  'leading-[16px] text-vibe3-neutral-body text-[12px]'
                )}
              >
