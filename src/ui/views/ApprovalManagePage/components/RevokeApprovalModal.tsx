...
export const RevokeApprovalModal = (props: {
      ...
      return item?.list.map((spenderHost, index) => {
        ...
        return (
          <div
            key={index}
            className={clsx(
              'relative px-[16px] h-[56px] bg-r-neutral-card1 cursor-pointer border border-transparent  hover:border-vibe3-blue-default  hover:bg-r-blue-light1 hover:bg-opacity-[0.1] hover:rounded-[6px] hover:z-10',
          ...
          >
            <div
              className={clsx(
                ...
                !isLastOne &&
                  'border-b-vibe3-neutral-line border-b-[0.5px] border-b-solid'
              )}
            >
    ...
    return item?.list.map((spender, index) => {
      ...
      return (
        <div
          key={spender.id}
          className={clsx(
            'relative px-[16px] bg-r-neutral-card1 cursor-pointer border border-transparent hover:border-vibe3-blue-default  hover:bg-r-blue-light1 hover:bg-opacity-[0.1] hover:rounded-[6px] hover:z-10',
            isLastOne && 'rounded-b-[6px]',
            'first:rounded-t-[6px]',
  ...
  return (
    ...
    >
      ...
      <div
        className={clsx(
          'absolute flex flex-col items-center justify-center bg-r-neutral-card1 left-0 bottom-0 w-full z-[99999] border-t border-vibe3-neutral-line',
          'px-[16px]'
        )}
