...
export const WithdrawConfirmPopup = ({
  ...
  return (
    ...
    >
      ...
      <div className="rounded-[8px] border-[0.5px] border-vibe3-neutral-line p-[16px] space-y-[16px] mb-[12px]">
          ...
          return (
            <div
              className={clsx(
                ...
                'border-transparent border-[1px] hover:border-vibe3-orange-DBK',
                isChecked && 'border-vibe3-orange-DBK'
              )}
              key={item.value}
              onClick={() => {
                if (isChecked) {
      ...
      <footer className="fixed left-0 right-0 bottom-0 px-[20px] py-[18px] border-t-[0.5px] border-vibe3-neutral-line bg-r-neutral-card1">
        <DbkButton
