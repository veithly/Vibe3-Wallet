    ...
    <Warper className="bg-r-neutral-bg2">
      <div className="p-[20px]">
        <div className="rounded-[8px] bg-r-neutral-card1 px-[16px] pt-[20px] pb-[16px]">
          ...
          <div className="rounded-[8px] border-[0.5px] border-vibe3-neutral-line p-[12px] flex items-center justify-between mb-[16px]">
          ...
          <div
            className={clsx(
              ...
              'hover:border-vibe3-orange-DBK',
              'focus-within:border-vibe3-orange-DBK'
            )}
          >
          ...
          <div className="rounded-[8px] border-[0.5px] border-vibe3-neutral-line p-[12px]">
      ...
      <footer className="fixed bottom-0 left-0 right-0 px-[20px] py-[18px] bg-r-neutral-bg-1 border-t-[0.5px] border-vibe3-neutral-line">
        <DbkButton
