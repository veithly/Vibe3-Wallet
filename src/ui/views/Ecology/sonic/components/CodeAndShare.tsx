  ...
  return (
    <div className="flex items-center justify-evenly w-full gap-[8px]">
      <button
        ...
        className={`bg-vibe3-sonic-card text-vibe3-sonic-card-foreground rounded-[8px] px-[12px] py-[8px] flex w-full items-center justify-center gap-[10px] font-bold border border-vibe3-sonic-card-border transition-all duration-200 ${
      ...
      {(referralCode || loading) && (
        <button
          disabled={loading}
          className={`bg-vibe3-sonic-card text-vibe3-sonic-card-foreground rounded-[8px] px-[12px] py-[8px] flex w-full items-center justify-center gap-[10px] font-bold border border-vibe3-sonic-card-border transition-all duration-200 hover:scale-[1.02] hover:shadow ${
            loading ? 'opacity-50 cursor-not-allowed pointer-events-none' : ''
          }`}
