...
const SonicPointsLink = ({
  ...
  return (
    <SonicCard className="flex items-center justify-between w-full gap-[8px] p-[12px] rounded-[8px] bg-vibe3-sonic-card text-vibe3-sonic-card-foreground">
...
const ErrorOverlay = ({ onRetry }: { onRetry: () => void }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 backdrop-blur-sm bg-vibe3-sonic-background flex flex-col items-center justify-center space-y-4 p-6">
...
const SonicPoints = () => {
  ...
  return (
    <div className="h-[100vh] min-h-[100vh] flex flex-col bg-r-sonic-background text-r-sonic-foreground relative">
      ...
      <div className="rounded-t-[20px] bg-vibe3-sonic-background p-[20px] mt-[-20px] flex flex-col gap-[16px]">
