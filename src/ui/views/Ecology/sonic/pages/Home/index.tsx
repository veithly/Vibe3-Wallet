...
export const SonicHome = () => {
  ...
  return (
    <div className="p-[12px] flex flex-col gap-[10px] bg-vibe3-sonic-background text-vibe3-sonic-foreground min-h-full">
      <MigrationBanner />
      ...
      <div className="flex flex-col items-center gap-y-[8px] pt-[16px] pb-[64px] text-vibe3-sonic-foreground">
        <div className="text-[16px] leading-[20px] font-semibold mb-[8px]">
          {t('page.ecology.sonic.home.socialsTitle')}
        </div>
        <div className="flex items-center gap-x-[10px] text-vibe3-sonic-foreground">
          {links.map((link) => (
