    ...
    >
      ...
      <div
        className={clsx(
          ...
          'border-[0.5px] border-solid border-vibe3-neutral-line'
        )}
      >
        <div className="gap-6 flex items-center">
      ...
      <div className="mt-12 mx-20">
        <Input
          ...
          className={clsx(
            'h-[52px] rounded-[8px]',
            'border-vibe3-neutral-line bg-r-neutral-bg1 hover:border-vibe3-blue-default focus:border-vibe3-blue-default',
      ...
      <div
        className={clsx(
          ...
          'border-t-[0.5px] border-solid border-vibe3-neutral-line',
          'px-20 py-16 mt-[22px]'
        )}
      >
        <Button
