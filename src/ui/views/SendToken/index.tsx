...
import { useVibe3Dispatch, connectStore, useVibe3Selector } from '@/ui/store';
import {
  getUiType,
  isSameAddress,
...
const ChainSelectWrapper = styled.div`
  ...
  &:hover {
    ...
    background-color: var(--r-blue-light-1, #DEF9C4);
    border-radius: 8px;
  }
`;
...
export const ToAddressCard = ({
  ...
  const { whitelist } = useVibe3Selector((s) => ({
                  ...
                  <ChainSelectWrapper>
                    <ChainSelectorInForm
                      ...
                      chainRenderClassName={clsx(
                        ...
                        'before:border-transparent hover:before:border-vibe3-blue-default pl-[8px]'
                      )}
                      drawerHeight={540}
                      showClosableIcon
                      getContainer={getContainer}
