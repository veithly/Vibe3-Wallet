...
export const ImportMyMetaMaskAccount = () => {
  ...
  return (
    <div className="add-metamask">
      ...
      <div className="vibe3-container text-r-neutral-title-1">
        <div
          style={{
            background:
        ...
        >
          ...
          <div className="rounded bg-vibe3-blue-light1 mt-12">
        ...
        <div className="bg-r-neutral-card-1 rounded-[6px] ">
          <div className="flex flex-col items-center border-vibe3-neutral-line py-[20px] px-[16px] pb-[24px]">
            ...
            <div
              className={clsx(
                'border border-transparent hover:border-vibe3-blue-default hover:bg-vibe3-blue-light1',
          ...
          <div className="flex flex-col items-center border-vibe3-neutral-line py-[20px] px-[16px] pb-[32px]">
            <div className="flex items-center mb-16">
              <span className="text-[13px] font-medium text-r-blue-default mr-2">
