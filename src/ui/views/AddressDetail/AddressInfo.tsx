...
const AddressInfo1 = ({ address, type, brandName, source }: Props) => {
  ...
  return (
    <div className="vibe3-list">
      <div className="vibe3-list-item">
        <div className="vibe3-list-item-content pr-11">
          <div className="vibe3-list-item-label">
            {t('page.addressDetail.address')}
            <div className="vibe3-list-item-desc flex gap-4 text-[12px]">
              {address}
              <img
                src={IconCopy}
          ...
          <div className="vibe3-list-item-extra"></div>
          <div className="vibe3-list-item-arrow"></div>
        </div>
      </div>
      <div className="vibe3-list-item">
        <div className="vibe3-list-item-content">
          <div className="vibe3-list-item-label">
            {t('page.addressDetail.address-note')}
          </div>
          <div
            className="vibe3-list-item-extra flex gap-[10px]"
      ...
      <div className="vibe3-list-item">
        <div className="vibe3-list-item-content">
          ...
          <div
            className="vibe3-list-item-extra truncate"
      ...
      <div className="vibe3-list-item">
        <div className="vibe3-list-item-content">
          ...
          <div className="vibe3-list-item-extra">
            <Popover
      ...
      <div className="vibe3-list-item">
        <div className="vibe3-list-item-content">
          ...
          <div className="vibe3-list-item-extra flex gap-[4px] max-w-full">
            <ThemeIcon
      ...
      {accountInfo && (
        <div className="vibe3-list-item">
          <div className="vibe3-list-item-content">
            ...
            <div className="vibe3-list-item-extra flex gap-[4px]">{`${accountInfo.hdPathTypeLabel} #${accountInfo.index}`}</div>
          </div>
        </div>
      )}
