...
const GnosisAdminItem = ({
  ...
  return (
    <div className="vibe3-list-item">
      <div className="vibe3-list-item-content py-0 min-h-[40px]">
...
export const GnonisSafeInfo = ({
  ...
  const [activeData, setActiveData] = useState<
    ...
    | undefined
  >(undefined);
  const { accountsList, highlightedAddresses } = useVibe3Selector((s) => ({
  ...
  if (safeInfo) {
    return (
      <>
        <div className="vibe3-list-item no-hover">
          <div className="vibe3-list-item-content border-0">
            <div>
              ...
              <div className="vibe3-list-item-desc text-r-neutral-body">
            ...
            <div className="vibe3-list-item-extra flex gap-[4px]"></div>
          </div>
        </div>
