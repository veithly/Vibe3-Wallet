  ...
  return (
    <>
      <div className="vibe3-list">
        <div
          className="vibe3-list-item cursor-pointer"
          onClick={handleClickDelete}
        >
          <div className="vibe3-list-item-content">
            <div className="vibe3-list-item-label" style={{ color: '#EC5151' }}>
              {t('page.addressDetail.delete-address')}
            </div>
            <div className="vibe3-list-item-arrow">
              <IconArrowRight
                width={16}
                height={16}
                viewBox="0 0 12 12"
