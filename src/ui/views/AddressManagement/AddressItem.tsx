...
import { useVibe3Dispatch } from '@/ui/store';
...
const AddressItem = memo(
  ({
    ...
    return (
      <div className={clsx(className, 'vibe3-address-item-container relative')}>
        ...
        >
          ...
          >
            ...
            >
              ...
              <div className={clsx('vibe3-address-item-content')}>
                {
                  <div className="vibe3-address-item-title" ref={titleRef}>
                    {
                      <>
                        <div
                          className={clsx(
                            'vibe3-address-item-alias',
              ...
              {enableSwitch && !isCurrentAccount && (
                <div className="vibe3-address-item-extra flex justify-center items-center pr-[12px]">
              ...
              {isCurrentAccount && (
                <div className="vibe3-address-item-extra flex items-center justify-center flex-1 overflow-hidden">
                  {isUpdatingBalance ? (
                    <>
                      <SkeletonInput
                        active
            ...
            <div
              className={clsx(
                'vibe3-address-item-arrow absolute h-full top-0 right-0 bottom-0 items-center justify-center',
