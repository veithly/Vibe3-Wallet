...
const Group = ({
  ...
  return (
    <div className="relative w-full p-[16px] bg-r-neutral-card-1 overflow-hidden rounded-[6px] pt-0">
      ...
      <div className="absolute left-0 top-[48px] w-full h-0 border-b-[0.5px] border-vibe3-neutral-line" />
      ...
      <Button
        ...
        type="primary"
        className={clsx(
          'bg-vibe3-blue-light1 w-full shadow-none h-[40px] border-transparent hover:border-vibe3-blue-default hover:bg-r-blue-light-2 hover:before:hidden',
