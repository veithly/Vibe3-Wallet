...
const PreferMEVGuardSwitch = styled(Switch)`
  ...
  &.ant-switch-checked {
    background-color: var(--r-blue-default, #468585);
    .ant-switch-handle {
          ...
          <div className="leading-4 mb-12 text-12 text-r-neutral-foot">
            <div className="flex justify-between">
              ...
              >
                ...
                >
                  <RcIconInfo className="ml-4 text-vibe3-neutral-foot w-14 h-14 " />
                </Tooltip>
              </span>
            </div>
            <div className="mt-[8px] rounded-[4px] border-[0.5px] border-vibe3-red-default bg-r-red-light p-8 text-13 font-normal text-r-red-default">
          ...
          {quoteLoading ? (
            ...
            <div
              className={clsx(
                ...
                isBestQuote &&
                  'border-[0.5px] border-solid border-vibe3-blue-default rounded-[4px] pr-[5px]'
              )}
            ...
            >
              ...
              <span className="text-12 text-vibe3-blue-default font-medium">
                {sourceName}
              </span>
    ...
    >
      <div
        className={clsx(
          ...
          'text-12 text-vibe3-neutral-title-1'
        )}
      >
        <Trans t={t} i18nKey={'page.bridge.recommendFromToken'}>
          ...
          <div
            className={clsx(
              ...
              'px-8 py-6 mx-6',
              'text-r-blue-default',
              'bg-vibe3-blue-light1 rounded-[6px]'
            )}
          >
            <TokenWithChain
              token={token}
