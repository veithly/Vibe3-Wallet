  ...
  ({ data }, ref) => {
    ...
    return (
      <div
        ...
        ref={ref}
      >
        <div className="flex justify-between items-center pb-8 border-b-[0.5px] border-solid border-vibe3-neutral-line gap-12">
        ...
        <div className="flex items-center text-12 text-r-neutral-foot pt-10 border-t-[0.5px] border-solid border-vibe3-neutral-line">
