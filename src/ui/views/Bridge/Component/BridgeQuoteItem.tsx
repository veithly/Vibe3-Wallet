...
export const BridgeQuoteItem = (props: QuoteItemProps) => {
  ...
  const aggregatorsList = useVibe3Selector(
    (s) => s.bridge.aggregatorsList || []
  );
  const selectedAggregators = useVibe3Selector(
      ...
      <ItemWrapper
        className={clsx(
          ...
          props.onlyShow
            ...
            : props.inSufficient
            ? 'h-[88px] p-16 pt-[20px] bg-transparent border-[1px] border-solid border-vibe3-neutral-line'
            : clsx(
                'h-[88px] p-16 pt-[20px] cursor-pointer',
                'bg-r-neutral-card1 border-[1px] border-solid border-transparent hover:bg-vibe3-blue-light1',
                ' hover:after:absolute hover:after:rounded-md hover:after:inset-[-1px] hover:after:border hover:after:border-vibe3-blue-default hover:after:pointer-events-none'
              )
        )}
        style={
      ...
      >
        <div className="flex items-center justify-between relative">
          ...
          <div className="flex items-center gap-8 flex-1 justify-end">
            ...
            <span
              className={clsx(
                'text-[16px] font-medium text-vibe3-neutral-title1 overflow-hidden overflow-ellipsis whitespace-nowrap',
