...
const getContainer = isTab ? '.js-vibe3-popup-container' : undefined;
...
export const Main = () => {
  const { userAddress } = useVibe3Selector((state) => ({
  ...
  const originPreferMEVGuarded = useVibe3Selector(
    ...
    <>
      ...
      >
        <div className="mb-8 mx-20">
          <ChainSelectorInForm
            ...
            chainRenderClassName={clsx(
              ...
              'before:border-transparent hover:before:border-vibe3-blue-default'
            )}
            drawerHeight={540}
            showClosableIcon
        ...
        >
          ...
          <div
            className={clsx(
              'w-full h-[0.5px] bg-vibe3-neutral-line',
        ...
        <div
          className={clsx(
            ...
            'bg-r-neutral-bg-2 border border-t-[0.5px] border-transparent border-t-vibe3-neutral-line',
            'py-[13px]',
