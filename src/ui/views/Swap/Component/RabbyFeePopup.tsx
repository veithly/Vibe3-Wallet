...
export const RabbyFeePopup = ({
  ...
  return (
    ...
    >
      ...
      <div className="text-14 text-center  text-vibe3-neutral-body leading-[150%]">
        {type === 'swap'
      ...
      <div className="border-[1px] border-vibe3-neutral-line rounded-[6px]">
        {fee[type].map((item, idx, list) => (
          <div
            ...
            className={clsx(
              'flex justify-between items-center',
              'px-16 h-[44px]',
              'border-b-[1px] border-solid border-vibe3-neutral-line',
              idx === list.length - 1 ? 'border-b-0' : ''
            )}
          >
            <div className="flex items-center">
              <img src={item.logo} className="w-[18px] h-[18px] mr-8" />
              <span className="text-13 leading-normal font-medium text-vibe3-neutral-title1">
                {item.name}
              </span>
            </div>
            <span className="text-13 leading-normal font-medium text-vibe3-neutral-title1">
