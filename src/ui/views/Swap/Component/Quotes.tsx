...
export const Quotes = ({
  ...
  const dexListLength = useVibe3Selector((s) => s.swap.supportedDEXList.length);
  ...
  return (
    <div className="flex flex-col flex-1 w-full overflow-auto pb-12 px-20">
      ...
      >
        <span className="text-13 text-vibe3-neutral-foot gap-4 ">
...
export const QuoteList = (props: Omit<QuotesProps, 'sortIncludeGasFee'>) => {
  ...
  const dexList = useVibe3Selector((s) => s.swap.supportedDEXList);
      ...
      title={
        <div className="flex items-center justify-between mb-[-2px] pb-10">
          ...
          <Checkbox
            ...
            className="text-12 text-vibe3-neutral-body"
            width="14px"
            height="14px"
            type="square"
