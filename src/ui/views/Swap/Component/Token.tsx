...
export const SwapTokenItem = (props: SwapTokenItemProps) => {
  ...
  return (
    <div className="p-16 pb-20 h-[132px]">
      ...
      >
        <span className="block w-[150px] text-vibe3-neutral-foot">
      ...
      <div className="flex items-center justify-between">
        <div
          className={clsx(
            ...
            isFrom && inSufficient
              ? 'text-r-red-default'
              : 'text-vibe3-neutral-foot'
          )}
        >
          <RcIconWalletCC viewBox="0 0 16 16" className="w-16 h-16" />
          <span className="text-13">{balance}</span>
        </div>
        <div className="text-13 text-vibe3-neutral-foot flex items-center gap-2 relative">
          {valueLoading && skeletonLoading ? (
            <SkeletonInput
              active
              className="rounded-[4px]"
