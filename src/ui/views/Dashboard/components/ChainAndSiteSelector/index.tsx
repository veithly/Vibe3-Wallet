...
import { ReactComponent as RcIconAgentStar } from '@/ui/assets/dashboard/agent-star.svg';
...
export default function ChainAndSiteSelector({
  ...
  const panelItems = {
    ...
    agent: {
      icon: RcIconAgentStar,
      eventKey: 'Agent',
      content: t('page.dashboard.home.panel.agent'),
      iconClassName: 'icon-agent-star',
      onClick: async () => {
        try {
