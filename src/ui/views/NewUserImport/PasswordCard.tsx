...
const Container = styled.div`
  ...
  .ant-input-affix-wrapper {
    ...
    &-focused,
    &-focused:hover {
      border: 2px solid var(--r-blue-default, #468585);
        ...
        >
          <div className="flex-1 mt-[18px]">
            <hgroup className="mb-[24px]">
              ...
              <p className="text-center text-vibe3-blue-default font-normal text-[16px] leading-[20px] mx-28">
            ...
            {(form) => {
              ...
              return (
                <footer className="mt-auto">
                  ...
                  >
                    {agreeTerm ? (
                      <div className={'text-vibe3-blue-default'}>
                    ...
                    <div className="text-[13px] text-r-neutral-body leading-[16px]">
                      ...
                      >
                        I agree to the{' '}
                        <span
                          className="text-vibe3-blue-default font-medium cursor-pointer"
                          onClick={(e) => {
                            e.stopPropagation();
                            gotoTermsOfUse();
                          }}
