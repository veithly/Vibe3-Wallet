...
import { connectStore, useVibe3Dispatch } from '@/ui/store';
...
const RiskCheck = () => {
  ...
  return (
    <Card title={t('page.newUserImport.createNewAddress.title')}>
      ...
      <div className="mt-[22px] mb-[26px] text-[16px] font-normal text-center text-vibe3-blue-default">
      ...
      <div className="flex flex-col gap-16">
        {questionChecks.map((item, index) => (
          ...
          >
            <IconDotCC
              className="mt-6 text-vibe3-blue-default flex-shrink-0"
              viewBox="0 0 8 8"
            />
