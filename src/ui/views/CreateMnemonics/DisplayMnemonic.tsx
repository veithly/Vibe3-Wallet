...
const DisplayMnemonic = () => {
  ...
  const { mnemonics } = useVibe3Selector((s) => ({
  ...
  return (
    <Card onBack={() => dispatch.createMnemonics.stepTo('risk-check')} step={1}>
      ...
      <div className="text-[16px] text-vibe3-blue-default font-normal text-center mb-20 mx-[10px]">
      ...
      <div
        className={clsx(
          ...
          'text-14 font-medium text-vibe3-blue-default',
          'hover:text-vibe3-blue-default'
        )}
        onClick={onCopyMnemonics}
      >
        <IconCopyCC
          className="w-20 h-20 text-vibe3-blue-default"
