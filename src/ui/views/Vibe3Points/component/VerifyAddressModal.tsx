  ...
  return (
    <div className="w-[360px] bg-r-neutral-bg-1 p-[20px] pb-[24px] rounded-[8px] leading-[normal]">
      <div className="text-r-neutral-title1 text-[20px] font-medium text-center">
        {t('page.vibe3Points.referralCode.verifyAddressModal.verify-address')}
      </div>
      <div className="mt-[12px] text-[15px]  text-r-neutral-body">
        {t(
          'page.vibe3Points.referralCode.verifyAddressModal.please-sign-this-text-message-to-verify-that-you-are-the-owner-of-this-address'
        )}
      </div>
      <div className="mt-[48px]  flex justify-center items-center gap-16">
        ...
        >
          {t('page.vibe3Points.referralCode.verifyAddressModal.cancel')}
        </Button>
        <Button
          type="primary"
          ...
          onClick={onConfirm}
        >
          {t('page.vibe3Points.referralCode.verifyAddressModal.sign')}
        </Button>
      </div>
    </div>
  );
