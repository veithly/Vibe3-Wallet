...
export const ClaimItem = (props: ClaimItemProps) => {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between pb-[12px] px-[16px] border-b-[0.5px] border-vibe3-neutral-line">
        ...
        <TooltipWithMagnetArrow
          ...
          title={t('page.vibe3Points.claimItem.disabledTip')}
          ...
          <div>
            <Button
              className={clsx(
                ...
                !props.claimLoading && disabled
                  ? 'disabled-btn border-vibe3-neutral-card-2 bg-r-neutral-card-2 text-r-neutral-foot text-opacity-50'
            ...
            >
              <div className="relative flex items-start justify-center gap-4 loading-button-wrapper">
                <span>
                  {t('page.vibe3Points.claimItem.claim')}{' '}
...
export const ClaimItemLoading = () => {
  return (
    <Wrapper className="border-[0.5px] border-vibe3-neutral-line">
      <div className="flex items-center justify-between pb-[12px] px-[16px]  border-b-[0.5px] border-vibe3-neutral-line">
