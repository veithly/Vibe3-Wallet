...
import { ReactComponent as IconLink } from '@/ui/assets/vibe3-points/link.svg';
import { ReactComponent as Icon1st } from '@/ui/assets/vibe3-points/1st.svg';
import { ReactComponent as Icon2nd } from '@/ui/assets/vibe3-points/2nd.svg';
import { ReactComponent as Icon3rd } from '@/ui/assets/vibe3-points/3rd.svg';
    ...
    <div
      className={clsx(
        ...
        props.showCurrentUser &&
          'absolute w-full bottom-0 bg-r-neutral-bg-1 bg-opacity-95 border-0 border-t-[0.5px] border-vibe3-neutral-line  backdrop-blur-[4px]',
        props.className
      )}
    >
