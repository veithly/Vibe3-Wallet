          ...
          <div className="px-20">
            <div className="flex justify-between text-14 text-r-neutral-body pt-[24px] pb-8">
              ...
              <div className="flex items-center flex-row gap-4">
                ...
                >
                  <RcIconInfo className="text-vibe3-neutral-foot w-14 h-14" />
                </Tooltip>
              </div>
            </div>
          </div>
...
const WithdrawContent = ({
  ...
  const { accountsList } = useVibe3Selector((s) => ({
    ...s.accountToDisplay,
  }));
    ...
    <div className="w-full h-full flex flex-col justify-center items-center">
      ...
      <div className="text-13 text-r-neutral-body text-center flex gap-4 items-center justify-center mb-20">
        ...
        gasAccountInfo.non_withdrawable_balance > 0 ? (
          ...
          >
            <RcIconHelp className="text-vibe3-neutral-foot w-14 h-14" />
          </Tooltip>
        ) : null}
      </div>
      ...
      <WrapperDiv
        className={clsx(
          ...
          'w-full mt-24 px-20 py-14 border-t-[0.5px] border-solid border-vibe3-neutral-line flex-col'
        )}
      >
        {Boolean(BalanceSuffix) && (
          <div className="flex items-center justify-center flex-row font-medium text-center text-vibe3-neutral-foot text-12">
            <RcIconInfo className="text-vibe3-neutral-foot w-14 h-14 mr-4" />
