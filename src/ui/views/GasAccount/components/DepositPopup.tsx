        ...
        >
          <div
            ...
            className={clsx(
              ...
              !disabled && 'hover:border-vibe3-blue-default',
    ...
    >
      <div className="flex flex-col h-full pt-20">
        <div>
          ...
          <div className="px-20">
            <div className="flex justify-between border-b-[0.5px] border-vibe3-neutral-line text-12 text-r-neutral-body pt-[24px] pb-8">
          ...
          {loading && (
            <div className="flex flex-col items-center justify-center pt-[80px]">
              <SvgIconLoading
                ...
                fill="var(--r-blue-default, #468585)"
              />
...
const GasAccountDepositContent = ({ onClose }: { onClose: () => void }) => {
  ...
  return (
    <div className="w-full h-full flex flex-col justify-center items-center leading-normal">
          ...
          <div className="flex items-center justify-between">
            {amountList.map((amount) => (
              <div
                ...
                className={clsx(
                  ...
                  'hover:bg-r-blue-light-2 hover:border-vibe3-blue-default',
                  selectedAmount === amount
                    ? 'bg-r-blue-light-1 border-vibe3-blue-default text-r-blue-default'
            ...
            <Input
              className={clsx(
                ...
                'border border-solid border-vibe3-neutral-line',
                'hover:bg-r-blue-light-2 hover:border-vibe3-blue-default',
                'input',
                selectedAmount === CUSTOM_AMOUNT
                  ? 'bg-r-blue-light-1 border-vibe3-blue-default'
                  : 'text-r-neutral-title1'
              )}
              style={{
      ...
      <div className="w-full mt-auto px-20 py-16 border-t-[0.5px] border-solid border-vibe3-neutral-line flex items-center justify-center">
        <Button
