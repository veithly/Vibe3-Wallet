...
const GasAccountInner = () => {
  ...
  // const gasAccount = useVibe3Selector((s) => s.gasAccount.account);
  ...
  const rightItems = React.useMemo(
    () => (
      ...
      >
        <Menu.Item
          className="px-12 h-40 flex items-center gap-[6px] bg-transparent hover:bg-transparent border-b-[0.5px] border-solid border-vibe3-neutral-line"
          onClick={() => {
