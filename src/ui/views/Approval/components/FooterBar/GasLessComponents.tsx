  ...
  return (
    <div
      className={clsx(
        ...
        directSubmit
          ? 'mt-8 bg-r-red-light border border-solid border-vibe3-red-default'
  ...
  return (
    <span
      className={clsx(
        ...
        directSubmit
          ? 'mt-8 bg-r-blue-light-1 border border-solid border-vibe3-blue-default h-[40px]'
      ...
      >
        ...
        <span
          className={clsx(
            ...
            !directSubmit && 'pr-6',
            directSubmit
              ? 'mt-8 rounded-[8px] border border-solid bg-r-red-light border-vibe3-red-default'
              : themeColor
  ...
  return (
    <div
      className={clsx(
        ...
        directSubmit
          ? 'bg-r-red-light border border-solid border-vibe3-red-default'
          : 'bg-r-neutral-card2 mt-[15px]'
      )}
    >
      {!directSubmit && (
