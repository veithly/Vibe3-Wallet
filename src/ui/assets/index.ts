...
export { ReactComponent as SvgIconArrowRight } from './pagination-arrow-right.svg';
...
export { ReactComponent as SvgIconLoading } from '@/ui/assets/loading-round.svg';
export { ReactComponent as SvgAlert } from '@/ui/assets/alert.svg';
