...
const Step = ({ step }: { step: 1 | 2 }) => {
  return (
    <div className="flex items-center justify-center gap-4">
      <IconDotCC className="text-vibe3-blue-default" viewBox="0 0 8 8" />
      <div
        className={clsx(
          'w-[16px] h-[1px]',
          step === 2 ? 'bg-vibe3-blue-default' : 'bg-vibe3-blue-light2'
        )}
      />
      <IconDotCC
        className={clsx(
          step === 2 ? 'text-vibe3-blue-default' : 'text-vibe3-blue-light2'
        )}
        viewBox="0 0 8 8"
      />
    </div>
