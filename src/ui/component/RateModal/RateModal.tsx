...
const DASHED_LINE_STYLE = {
  ...
  height: 0,
  width: '100%',
  borderBottom: '1px dashed var(--r-blue-default, #468585)',
};

function useForceDisableRateGuideOnLaunch(modalShow: boolean) {
  const rDispatch = useVibe3Dispatch();
  const { disableExposureRateGuide } = useExposureRateGuide();

  const shouldForceDisableOnLaunch = useVibe3Selector(
    (s) =>
    ...
    >
      {!wantFeedback ? (
        ...
        >
            ...
            <div className="relative w-[100%]">
              <Input.TextArea
                ...
                className={clsx(
                  ...
                  'bg-r-neutral-card-1 border-vibe3-blue-default border-[1px] border-solid',
                  feedbackOverLimit && 'border-vibe3-red-default'
                )}
              ...
              <span
                className={clsx(
                  ...
                  feedbackOverLimit && 'text-vibe3-red-default'
                )}
              >
          ...
          <footer className="flex w-[100%] p-[16px] border-t-[0.5px] border-vibe3-neutral-line border-solid pb-[16px]">
            <Button
