    ...
    <div className={clsx(!!errMsgs.length && 'with-error')}>
      <HeadToolbar className="mb-[20px] text-r-neutral-body">
        ...
        {hasInputValue && (
          ...
          >
            <RcIconClearAll
              viewBox="0 0 18 18"
              className="w-[18px] h-[18px] text-vibe3-blue-default"
            />
            {!newUserImport && (
      ...
      <MatrixWrapper
        className={clsx(
          ...
          !newUserImport && 'border border-vibe3-neutral-line border-solid',
          isSlip39 && 'hidden',
  ...
  return (
    <div className="relative ">
      <Input
        ...
        onPaste={onPaste}
        className={clsx(
          'h-[56px] border-vibe3-neutral-line bg-vibe3-neutral-card-1 ',
          'text-15 text-r-neutral-title-1 font-normal leading-[18px]',
          error ? 'border-vibe3-red-default' : '',
