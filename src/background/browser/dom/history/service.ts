...
export async function findHistoryElementInTree(
  ...
  const hashedDomHistoryElement = await hashDomHistoryElement(
    domHistoryElement
  );
 ...
 */
async function hashDomHistoryElement(
  domHistoryElement: DOMHistoryElement
): Promise<HashedDomElement> {
 ...
 */
async function _parentBranchPathHash(
 ...
 */
async function _attributesHash(
