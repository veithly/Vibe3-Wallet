...
// for page provider
import { walletController, providerController } from './controller';

browser.runtime.onConnect.addListener((port) => {
  if (port.name === 'rabby-agent-connection') {
    agentService.setupConnection(port as any);
    return;
  }
  if (
    port.name === 'popup' ||
