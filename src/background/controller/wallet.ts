...
import { setPopupIcon } from '@/background/utils/index';
...
export class WalletController extends BaseController {
  ...
  setRedirect2Points = Vibe3PointsService.setRedirect2Points;
  setVibe3PointsSignature = Vibe3PointsService.setSignature;
  getVibe3PointsSignature = Vibe3PointsService.getSignature;
  clearVibe3PointsSignature = Vibe3PointsService.clearSignature;
  ...
  rabbyPointVerifyAddress = async (params?: {
    ...
    this.setVibe3PointsSignature(account.address, signature);
    if (claimSnapshot) {
      try {
